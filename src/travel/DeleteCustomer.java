...
// throws SQLException
	DeleteCustomer(String username) {
		...
		contentPane.setLayout(null);
                ...
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("travel/icons/delete.png"));
		...
		contentPane.add(lb3);
                ...
                try{
                    ...
                    ResultSet rs = c.s.executeQuery("select * from addacustomer");
                    while(rs.next()){
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String s1 = c1.getSelectedItem(); 
                                ...
                                String q1 = "update from addacustomer where username = '"+s1+"'";
